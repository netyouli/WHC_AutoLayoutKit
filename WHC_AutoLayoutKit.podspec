Pod::Spec.new do |s|
  ...
  s.version      = "2.6.4"
  s.summary      = "Service to update constraints, convenient and quick dynamic UI layout，服务于更新约束方便快捷动态UI的自动布局库，支持Cell和Tableview高度自适应，UILabel,ScrollView,UIView内容自适应"
