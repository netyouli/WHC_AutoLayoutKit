...
- (void)viewDidLoad {
    ...
    container1.whc_Orientation = Horizontal;// 自动横向布局
    ...
    container2.whc_Orientation = Horizontal;// 自动横向布局
    ...
    subContainer21.whc_Orientation = Horizontal;// 自动横向布局
    ...
    subContainer22.whc_Orientation = Horizontal;// 自动横向布局
