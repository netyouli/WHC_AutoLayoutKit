...
- (AutoContentSize)whc_AutoContentSize {
    __weak typeof(self) weakSelf = self;
    return ^() {
        if ([weakSelf isKindOfClass:[UIScrollView class]]) {
            ...
            ((UIScrollView *)weakSelf).contentSize = CGSizeMake(contentWidth, contentHeight);
        }else {
                ...
                case NSLayoutRelationEqual: {
                    if (constraint == nil) {
                        [self setSelfHeightConstraint:constraint];
                         ...
                         [self setEquelHeightConstraint:constraint];
                    }
                }
                    break;
            ...
            switch (constraint.relation) {
                case NSLayoutRelationEqual: {
                    if (constraint == nil) {
                        ...
                        [self setEquelWidthConstraint:constraint];
                    }
                }
                    break;
                case NSLayoutRelationGreaterThanOrEqual: {
        ...
        if (constraint.firstItem == view) {
            switch (attribute) {
                ...
                case NSLayoutAttributeWidth: {
                    ...
                    if (toView == nil && attribute == NSLayoutAttributeWidth) {
                        switch (related) {
                            case NSLayoutRelationEqual: {
                                NSLayoutConstraint * autoWidthConstraint = [view autoWidthConstraint];
                                NSLayoutConstraint * equelWidthConstraint = [view.superview equelWidthConstraint];
                                ...
                                if (equelWidthConstraint) {
                                    ...
                                    [view.superview setEquelWidthConstraint:nil];
                                }
                    ...
                    }else if (toView && attribute == NSLayoutAttributeWidth) {
                        NSLayoutConstraint * selfWidthConstraint = [view selfWidthConstraint];
                        NSLayoutConstraint * autoWidthConstraint = [view autoWidthConstraint];
                        if (selfWidthConstraint) {
                            [view removeConstraint:selfWidthConstraint];
...
//                    for (NSLayoutConstraint * selfConstraint in view.constraints) {
//                        if (selfConstraint.firstAttribute == NSLayoutAttributeWidth &&
//                            selfConstraint.relation != related) {
//                            [view removeConstraint:selfConstraint];
//                            break;
//                        }
//                    }
                    break;
                ...
                case NSLayoutAttributeHeight: {
                    ...
                    if (toView == nil && attribute == NSLayoutAttributeHeight) {
                        switch (related) {
                            case NSLayoutRelationEqual: {
                                NSLayoutConstraint * autoHeightConstraint = [view autoHeightConstraint];
                                NSLayoutConstraint * equelHeightConstraint = [view.superview equelHeightConstraint];
                                ...
                                if (equelHeightConstraint) {
                                    ...
                                    [view.superview setEquelHeightConstraint:nil];
                                }
                    ...
                    }else if (toView && attribute == NSLayoutAttributeHeight) {
                        NSLayoutConstraint * selfHeightConstraint = [view selfHeightConstraint];
                        NSLayoutConstraint * autoHeightConstraint = [view autoHeightConstraint];
                        if (selfHeightConstraint) {
                            [view removeConstraint:selfHeightConstraint];
...
//                    if (toView == nil) {
//                        for (NSLayoutConstraint * superConstraint in view.superview.constraints) {
//                            if (superConstraint.firstItem == view &&
//                                superConstraint.firstAttribute == NSLayoutAttributeHeight) {
//                                [view.superview removeConstraint:superConstraint];
//                                break;
//                            }
//                        }
//                    }
...
//                    }
        ...
        if (toView) {
            if (constraint.firstItem == view &&
                ...
                return constraint;
            }else if (constraint.firstItem == view &&
                      constraint.firstAttribute == attribute &&
